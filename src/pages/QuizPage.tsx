...
const page1Images: StyleImage[] = [
  ...
  { id: 8, url: "/images/images1/IMG_4961.JPG", style: "ESSENTIALS" },
  { id: 9, url: "/images/images1/IMG_4962.JPG", style: "COWBOY" },
];

// Images for the second page (from images2 folder)
const page2Images: StyleImage[] = [
  { id: 10, url: "/images/images2/IMG_4968.JPG", style: "ESSENTIALS" },
  { id: 11, url: "/images/images2/IMG_4969.JPG", style: "LUXURY" },
  { id: 12, url: "/images/images2/IMG_4971.JPG", style: "COWBOY" },
  { id: 13, url: "/images/images2/IMG_4972.JPG", style: "STREETWEAR" },
  { id: 14, url: "/images/images2/IMG_4973.JPG", style: "MINIMALIST" },
  { id: 15, url: "/images/images2/IMG_4974.JPG", style: "PUNK" },
  { id: 16, url: "/images/images2/IMG_4975.JPG", style: "VINTAGE" },
  { id: 17, url: "/images/images2/IMG_4976.JPG", style: "Y2K" },
  { id: 18, url: "/images/images2/IMG_4977.JPG", style: "GRUNGE" },
];
...
const QuizPage = () => {
  ...
  const currentImages = currentPage === 1 ? page1Images : page2Images;
  const currentSelections = currentPage === 1 ? selectedImagesPage1 : selectedImagesPage2;
  const maxSelections = currentPage === 1 ? 5 : 4;
                  ...
                  {currentImages.map((image) => (
                    <div 
                      ...
                      className={`aspect-[3/4] rounded-lg overflow-hidden cursor-pointer relative ${
                        currentSelections.includes(image.id) ? 'ring-2 ring-offset-2 ring-purple-500' : ''
                    ...
                    >
                      ...
                      />
                      {currentSelections.includes(image.id) && (
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-4">
                  ...
                  <Button 
                    ...
                    disabled={
                      currentSelections.length === 0 || isLoading
                    }
                  >
