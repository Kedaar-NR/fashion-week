  ...
  return <motion.div initial={{
    ...
    duration: 0.5
      ...
      <div className="flex-grow p-4 bg-gray-50">
        <h1 className="text-5xl font-bold text-center my-8 text-zinc-950 md:text-5xl">CURATED FOR YOU:</h1>
                ...
                <div className="rounded-xl p-3 mb-2 overflow-hidden bg-gray-900">
                  <div className="flex flex-col items-center justify-center mb-4">
                    <div className="w-16 h-16 rounded-full overflow-hidden mb-3 bg-gray-800 flex items-center justify-center">
                      <img src={`/src/profile_pics /${cleanName}.jpg`} alt={brand.name} className="h-full w-full object-cover" onError={e => {
                    ...
                    <div className="text-center">
                      ...
                      <div className="flex flex-wrap gap-1 mt-2 justify-center">
                        {getBrandTags(brand).map((tag, i) => <span key={i} className={`px-2 py-0.5 rounded-full ${tag.color} ${tag.textColor} text-xs font-medium`}>
                            {tag.name}
                          </span>)}
                      </div>
                    </div>
        ...
        <div className="flex justify-center mt-6 mb-8">
          <Button onClick={handleFinish} className="text-xl px-10 py-6 h-auto rounded-none font-normal bg-zinc-950 hover:bg-zinc-800 text-slate-50">
            Next
          </Button>
        </div>
      </div>
